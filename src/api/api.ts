 ...
 * 
 * @export
 * @interface GetFeedbackDto
 */
export interface GetFeedbackDto {
    /**
     * Номер телефона
     * @type {string}
     * @memberof GetFeedbackDto
     */
    phone: string;
    /**
     * Эл. почта пользователя
...
export const FeedbackApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createFeedback: async (createFeedbackDto: CreateFeedbackDto, options: any = {}): Promise<RequestArgs> => {
        ...
        /**
         * 
         * @summary Удаление фидбека по ID
         * @param {string} feedbackId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteFeedback: async (feedbackId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'feedbackId' is not null or undefined
            assertParamExists('deleteFeedback', 'feedbackId', feedbackId)
            const localVarPath = `/feedbackID`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * 
         * @summary Получить все фидбеки
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllFeedback: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/feedback`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getFeedbackById: async (feedbackId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'feedbackId' is not null or undefined
            assertParamExists('getFeedbackById', 'feedbackId', feedbackId)
...
export const FeedbackApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createFeedback(createFeedbackDto: CreateFeedbackDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFeedbackDto>> {
         ...
         * @throws {RequiredError}
         */
        async deleteFeedback(feedbackId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async getAllFeedback(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetFeedbackDto>>> {
         ...
         * @throws {RequiredError}
         */
        async getFeedbackById(feedbackId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFeedbackDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFeedbackById(feedbackId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const FeedbackApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createFeedback(createFeedbackDto: CreateFeedbackDto, options?: any): AxiosPromise<GetFeedbackDto> {
         ...
         * @throws {RequiredError}
         */
        deleteFeedback(feedbackId: string, options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        getAllFeedback(options?: any): AxiosPromise<Array<GetFeedbackDto>> {
         ...
         * @throws {RequiredError}
         */
        getFeedbackById(feedbackId: string, options?: any): AxiosPromise<GetFeedbackDto> {
            return localVarFp.getFeedbackById(feedbackId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class FeedbackApi extends BaseAPI {
     ...
     */
    public createFeedback(createFeedbackDto: CreateFeedbackDto, options?: any) {
        return FeedbackApiFp(this.configuration).createFeedback(createFeedbackDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FeedbackApi
     */
    public deleteFeedback(feedbackId: string, options?: any) {
    ...
    public getAllFeedback(options?: any) {
        return FeedbackApiFp(this.configuration).getAllFeedback(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FeedbackApi
     */
    public getFeedbackById(feedbackId: string, options?: any) {
        return FeedbackApiFp(this.configuration).getFeedbackById(feedbackId, options).then((request) => request(this.axios, this.basePath));
    }
}
